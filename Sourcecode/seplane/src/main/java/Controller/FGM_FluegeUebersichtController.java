...
public class FGM_FluegeUebersichtController implements Initializable {
    ...
    @FXML
    private TableColumn<Flug, String> jungfernflug_column;
    ...
    @FXML
    private TableColumn<Flug, String> preisEconomy_column;

    @FXML
    private TableColumn<Flug, String> preisBusiness_column;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        jungfernflug_column.setCellValueFactory(cellData->{
            if(cellData.getValue()==null){
                return new SimpleStringProperty("");
            }
            else{
                SimpleStringProperty simpleStringProperty = new SimpleStringProperty();
                simpleStringProperty.setValue(cellData.getValue().getFluglinie().getStartdatum().toString());
                return simpleStringProperty;
            }
        });
        Flugzeug_column.setCellValueFactory(new PropertyValueFactory<>(""));
        ...
        preisEconomy_column.setCellValueFactory(cellData->{
            if(cellData.getValue()==null){
                return new SimpleStringProperty("");
            }
            else{
                SimpleStringProperty simpleStringProperty = new SimpleStringProperty();
                simpleStringProperty.setValue(cellData.getValue().getFluglinie().getPreisee().toString());
                return simpleStringProperty;
            }
        });
        preisBusiness_column.setCellValueFactory(cellData->{
            if(cellData.getValue()==null){
                return new SimpleStringProperty("");
            }
            else{
                SimpleStringProperty simpleStringProperty = new SimpleStringProperty();
                simpleStringProperty.setValue(cellData.getValue().getFluglinie().getPreiseb().toString());
                return simpleStringProperty;
            }
        });
